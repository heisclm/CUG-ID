...
const Sidebar = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  const menuItems = [
    { name: 'Dashboard', icon: LayoutDashboard, href: '/', roles: ['STUDENT', 'ADMIN', 'SECURITY', 'INVIGILATOR'] },
    ...
    { name: 'Manage Staff', icon: ShieldCheck, href: '/admin/staff', roles: ['ADMIN'] },
    { name: 'Approvals', icon: ShieldCheck, href: '/admin/approvals', roles: ['ADMIN'] },
    { name: 'Scanner', icon: ShieldCheck, href: '/security/scan', roles: ['SECURITY', 'INVIGILATOR', 'ADMIN'] },
    { name: 'Settings', icon: Settings, href: '/settings', roles: ['STUDENT', 'ADMIN', 'SECURITY', 'INVIGILATOR'] },
  ];
